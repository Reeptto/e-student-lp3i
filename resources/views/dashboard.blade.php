...
<div class="max-w-6xl mx-auto space-y-10 py-10 px-6">
    ...
    <div class="mecha-wrapper" style="--dark-theme: #b91c1c;">
        ...
        <div class="mecha-border" x-data="{ open: true }">
            <div @click="open = !open" class="bg-gradient-to-r from-[#dc2626] to-[#7f1d1d] px-6 py-4 flex justify-between items-center text-white cursor-pointer select-none border-b-4 border-red-800">
                <h3 class="font-black text-xl italic uppercase tracking-wider flex items-center gap-3"><i data-lucide="sparkles" class="w-6 h-6 text-yellow-300 fill-current"></i> E-STUDENT INFO</h3>
