...
<div class="relative overflow-hidden w-full lg:w-1/2 bg-white shadow-xl shadow-gray-300/40 rounded-2xl flex flex-col justify-center border border-gray-100" id="du">
    ...
    <div class="relative z-10 w-full p-10 lg:p-16">
        ...
        <h2 class="text-3xl lg:text-4xl font-extrabold text-[#4b2aad] mb-4">
            Informasi E-Student
        </h2>
        ...
        <div class="grid grid-cols-2 gap-x-6 gap-y-6 my-8">
            ...
            <div class="space-y-5">
                ...
                <span class="flex items-center text-black font-medium">
                    <svg class="w-6 h-6 text-[#4b2aad] mr-3 flex-shrink-0" xmlns="http://www.w3.org/2G00/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
 ...
 font-family: 'Poppins', sans-serif !important;
        ...
        *{
        ...
        .input-style:focus {
            outline: none;
            border-color: #6366f1; /* Fokus warna Indigo (baru) */
